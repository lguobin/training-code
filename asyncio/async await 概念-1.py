# !/usr/bin/env python
# -*- coding: utf-8 -*-
# @Date     : 2020/05/11 17:10:44
# @File     : async await 概念-1.py
...
def consum_time(func):
    ...
    def wrapper(*args, **kw):
        ...
        print(f"当前方法名: {func.__name__} | 耗时 - {(over_time - start_time).total_seconds()} | 开始运行时间: {start_time}")
        return res
    return wrapper
...
def demo1():
    ...
    打印:
        ...
        washer2 finished
        washer3 finished
        当前方法名: demo1 | 耗时 - 10.0 | 开始运行时间: 2020-05-19 17:38:17.945200
    """
...
def demo2():
    ...
    """
    打印:
        概念-1.py:91: RuntimeWarning: coroutine 'demo2.<locals>.washing1' was never awaited
        washing1()
        await 概念-1.py:92: RuntimeWarning: coroutine 'demo2.<locals>.washing2' was never awaited
        washing2()
        await 概念-1.py:93: RuntimeWarning: coroutine 'demo2.<locals>.washing3' was never awaited
        washing3()
        当前方法名: demo2 | 耗时 - 0.007 | 开始运行时间: 2020-05-19 17:39:35.522200
    """
...
def demo3():
    ...
    """
    打印:
        await 概念-1.py:146: RuntimeWarning: coroutine 'demo3.<locals>.washing1' was never awaited
        washing1()
        await 概念-1.py:147: RuntimeWarning: coroutine 'demo3.<locals>.washing2' was never awaited
        washing2()
        await 概念-1.py:148: RuntimeWarning: coroutine 'demo3.<locals>.washing3' was never awaited
        washing3()
        当前方法名: demo3 | 耗时 - 0.007 | 开始运行时间: 2020-05-19 17:40:18.215200
    """
...
def demo4():
    ...
    打印:
        ...
        washer1 finished
        washer3 finished
        当前方法名: demo4 | 耗时 - 5.087 | 开始运行时间: 2020-05-19 17:40:53.352200
    """
